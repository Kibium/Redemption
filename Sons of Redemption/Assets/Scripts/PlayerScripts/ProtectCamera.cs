...
public class ProtectCamera : MonoBehaviour {
    ...
    public float DistanciaCam;
    public bool DistanciaCamB;
    ...
    void Update()
    {
        ...
        {
            m_OriginalDist = 1;// la distancia entre camera y player sera 1
        }
        else
        {
            // la distancia entre camera y player sera lo que haya en la variable DistanciaCam
            m_OriginalDist = DistanciaCam;
        }


        if (Input.GetKeyDown("z") && DistanciaCam == 2.5f && DistanciaCamB == true)
        {
            DistanciaCam = 15f;
            DistanciaCamB = false;
        }

        if (Input.GetKeyDown("z") && DistanciaCam == 1.5f && DistanciaCamB == true)
        {
            DistanciaCam = 2;
            DistanciaCamB = false;
        }

        if (Input.GetKeyDown("z") && DistanciaCam == 2 && DistanciaCamB == true)
        {
            DistanciaCam = 2.5f;
            DistanciaCamB = false;
        }
    ...
    {
        if (DistanciaCamB == false)
        { //Si DistanciaCamB esta en false
            DistanciaCamB = true;   //La ponemos en true
        }
