...
public class AimBehaviourBasic : GenericBehaviour
{
	...
	void Start ()
	{
		...
		aimBool = Animator.StringToHash("Aim"); //https://docs.unity3d.com/ScriptReference/Animator.StringToHash.html Genera parametro segun un string (?)
            //Le damos a un int un valor string para animator. Así en l futuro no tendremos que hacer SetString en las animaciones, solo setBool.
    }
    ...
    void Update ()
	{
       // Cursor.visible = false;
		...
		if (Input.GetAxisRaw(aimButton) != 0 && !aim && GameManager.playerGetPistola) //Si está aprentaoad al boton y no está apuntando
		{
